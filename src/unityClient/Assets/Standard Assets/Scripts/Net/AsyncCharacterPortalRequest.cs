...
public class AsyncCharacterPortalRequest 
{
    public delegate void OnRequestCompleteDelegate(AsyncCharacterPortalRequest asyncRequest);

    private const float WITHIN_PORTAL_TOLERANCE_SQUARED = 0.1f * 0.1f;
    ...
    public RoomKey OriginalRoomKey { get; private set; }

	public RoomPortal OriginPortal { get; private set; }
    public Point3d OriginPortalEntryPoint { get; private set; }
