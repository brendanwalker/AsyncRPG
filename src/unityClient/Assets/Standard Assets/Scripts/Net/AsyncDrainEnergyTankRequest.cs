...
public class AsyncDrainEnergyTankRequest 
{
    public delegate void OnRequestCompleteDelegate(AsyncDrainEnergyTankRequest asyncRequest);
	...
	{		
		...
		if (pathResult.ResultCode == PathComputer.eResult.success)
		{
            ...
            serverRequest.POST(
                ServerConstants.energyTankDrainRequestURL, 
                requestPayload,
